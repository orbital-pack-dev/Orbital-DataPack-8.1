execute unless entity @e[tag=ms_safe_setup,distance=..0.35,limit=1,type=minecraft:interaction] unless entity @e[tag=ms_safe_awaiting_key,distance=..0.35,limit=1,type=minecraft:interaction] run function mosseater:safe/spawn_setup_double
