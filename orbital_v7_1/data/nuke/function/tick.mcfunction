...
execute as @a if items entity @s weapon.offhand minecraft:fishing_rod[minecraft:custom_data~{stabshot:1}] at @s run function nuke:orbital_strike_cannon/upgrade/trigger
execute as @a if items entity @s weapon.offhand minecraft:fishing_rod[minecraft:custom_data~{nukeshot:1}] at @s run function nuke:orbital_strike_cannon/upgrade_nukeshot/trigger
...
execute as @a if items entity @s weapon.mainhand minecraft:crossbow[minecraft:custom_data~{orbital_mortar_bow:1}] run tag @s add holding_orb_mortar
...
# ════════════════════════════════════════════════════════════
execute as @a if items entity @s weapon.mainhand minecraft:shield[minecraft:custom_data~{archi_shield:1}] at @s run function nuke:archi_shield/main
execute as @a unless items entity @s weapon.mainhand minecraft:shield[minecraft:custom_data~{archi_shield:1}] if items entity @s weapon.offhand minecraft:shield[minecraft:custom_data~{archi_shield:1}] at @s run function nuke:archi_shield/main
execute as @a[scores={archi_delay=1..}] unless items entity @s weapon.mainhand minecraft:shield[minecraft:custom_data~{archi_shield:1}] unless items entity @s weapon.offhand minecraft:shield[minecraft:custom_data~{archi_shield:1}] run scoreboard players remove @s archi_delay 1

# ════════════════════════════════════════════════════════════
# CHAOS UPDATE TICKS
# ════════════════════════════════════════════════════════════
# 1) Подрывной Жилет
execute as @a if items entity @s armor.chest minecraft:chainmail_chestplate[minecraft:custom_data~{blast_vest:1}] at @s run function nuke:blast_vest/main

# 2) Лёгкий ТНТ (wind_charge)
execute as @a at @s if items entity @s weapon.mainhand minecraft:wind_charge[minecraft:custom_data~{light_tnt:1}] run tag @e[type=wind_charge,distance=..6,tag=!lt_processed] add light_tnt
...
# Замком управляет ванильный компонент minecraft:lock, ежетиковых макросов нет.
...
execute as @a if items entity @s weapon.* minecraft:potion[minecraft:custom_data~{potion_of_saturation:1}] at @s run function nuke:potion_of_saturation/visuals
