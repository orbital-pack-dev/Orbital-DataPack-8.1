...
execute if entity @s[tag=ms_safe_guard] run return run function mosseater:safe/access_check
# Legacy/повреждённая shield без state-tag больше не поглощает клик молча.
