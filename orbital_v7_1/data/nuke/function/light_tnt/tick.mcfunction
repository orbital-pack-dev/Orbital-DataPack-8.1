# Тик Лёгкого ТНТ: следование за снарядом и вращение.
execute as @e[type=wind_charge,tag=light_tnt] at @s run tp @e[type=block_display,tag=lt_display,distance=..3,limit=1,sort=nearest] ~ ~ ~
