# Один делитель на всех и ОДИН массовый декремент вместо вызова на каждый заряд.
...
execute as @e[type=minecraft:block_display,tag=tt_display,scores={tt_timer=1..}] at @s run function nuke:timer_tnt/tick_one
