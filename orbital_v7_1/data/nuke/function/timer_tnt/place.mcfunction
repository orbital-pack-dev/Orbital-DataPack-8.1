# Установка заряда. Хитбокс — настоящий блок minecraft:tnt.
...
summon minecraft:text_display ~0.5 ~1.4 ~0.5 {Tags:["tt_text","tt_new"],billboard:"center",see_through:1b,text:[{text:"ТАЙМЕР-ТНТ",color:"red",bold:true}]}
