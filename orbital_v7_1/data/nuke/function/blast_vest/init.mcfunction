...
# Базовый таймер: 10 секунд (200 тиков). Админ-настройка t_bv_time может переопределить.
scoreboard players set @s bv_timer 200
...
tellraw @s [{"text":"[ЖИЛЕТ] ","color":"red","bold":true},{"text":"Таймер активирован: 10 секунд. Shift — досрочный подрыв.","color":"gold"}]
