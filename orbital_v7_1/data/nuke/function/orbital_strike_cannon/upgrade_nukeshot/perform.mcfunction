# Выдача апгрейда. nuke.temp: 1 = mainhand, 2 = offhand (выставлен в trigger).
# Новый предмет ложится ИМЕННО В ТУ РУКУ, где лежала старая удочка.
...
execute if score @s nuke.power matches 2 if score @s nuke.temp matches 1 run item replace entity @s weapon.mainhand with fishing_rod[custom_data={nukeshot:1b,nukeshot_power:2,power_level:2,nukeshot_p2:1b,power_tag:"power_2"},custom_model_data={floats:[1002f]},custom_name={"italic":false,"color":"red","text":"NukeShot | Power-2"},rarity="rare",damage=63]
execute if score @s nuke.power matches 2 if score @s nuke.temp matches 2 run item replace entity @s weapon.offhand with fishing_rod[custom_data={nukeshot:1b,nukeshot_power:2,power_level:2,nukeshot_p2:1b,power_tag:"power_2"},custom_model_data={floats:[1002f]},custom_name={"italic":false,"color":"red","text":"NukeShot | Power-2"},rarity="rare",damage=63]
...
execute if score @s nuke.power matches 3 if score @s nuke.temp matches 1 run item replace entity @s weapon.mainhand with fishing_rod[custom_data={nukeshot:1b,nukeshot_power:3,power_level:3,nukeshot_p3:1b,power_tag:"power_3"},custom_model_data={floats:[1003f]},custom_name={"italic":false,"color":"dark_red","text":"NukeShot | Power-3"},rarity="epic",damage=63]
execute if score @s nuke.power matches 3 if score @s nuke.temp matches 2 run item replace entity @s weapon.offhand with fishing_rod[custom_data={nukeshot:1b,nukeshot_power:3,power_level:3,nukeshot_p3:1b,power_tag:"power_3"},custom_model_data={floats:[1003f]},custom_name={"italic":false,"color":"dark_red","text":"NukeShot | Power-3"},rarity="epic",damage=63]
...
execute if score @s nuke.power matches 4 if score @s nuke.temp matches 1 run item replace entity @s weapon.mainhand with fishing_rod[custom_data={nukeshot:1b,nukeshot_power:4,power_level:4,nukeshot_p4:1b,power_tag:"power_4"},custom_model_data={floats:[1004f]},custom_name={"italic":false,"color":"dark_red","text":"NukeShot | Power-4"},rarity="epic",damage=63]
execute if score @s nuke.power matches 4 if score @s nuke.temp matches 2 run item replace entity @s weapon.offhand with fishing_rod[custom_data={nukeshot:1b,nukeshot_power:4,power_level:4,nukeshot_p4:1b,power_tag:"power_4"},custom_model_data={floats:[1004f]},custom_name={"italic":false,"color":"dark_red","text":"NukeShot | Power-4"},rarity="epic",damage=63]
