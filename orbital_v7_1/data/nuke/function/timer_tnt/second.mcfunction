# Раз в секунду. Контекст: as <marker tt_marker>, at @s.
...
execute as @e[type=minecraft:text_display,tag=tt_text,distance=..3,limit=1,sort=nearest] run function nuke:timer_tnt/set_text with storage nuke:tt
