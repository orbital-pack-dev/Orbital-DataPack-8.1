...
execute as @e[distance=..6,tag=!tt_hitbox,type=!minecraft:item,type=!minecraft:marker,type=!minecraft:block_display,type=!minecraft:text_display,type=!minecraft:item_display,type=!minecraft:interaction,type=!minecraft:experience_orb,type=!minecraft:area_effect_cloud] run function nuke:timer_tnt/hurt
...
kill @e[type=minecraft:armor_stand,tag=tt_hitbox,distance=..2]
kill @s
